...
try:
    new_ACT = float(input("Masukkan nilai ACT composite score: "))  # Mengonversi input ke float
    new_SAT = float(input("Masukkan nilai SAT total score: "))      # Mengonversi input ke float
    new_GPA = float(input("Masukkan nilai rata-rata SMA: "))        # Mengonversi input ke float
    new_income = float(input("Masukkan nilai pendapatan orang tua: "))  # Mengonversi input ke float
    new_education = float(input("Masukkan tingkat pendidikan orang tua (angka): "))  # Mengonversi input ke float
